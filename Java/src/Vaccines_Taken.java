...
public class Vaccines_Taken extends JFrame {
	...
	private void table_update(){
		...
		try {
			...
			String sql = "SELECT v.v_name FROM vaccine v where v.taken = 'Yes' and v.id = '"+no+"'ORDER BY due_date ASC;";
...
//					v2.add(rs.getString("end_date"));
	...
	public Vaccines_Taken() {
		...
		JLabel lblNewLabel = new JLabel("Vaccines Taken");
		...
		table.setBounds(270, 134, 344, 344);
